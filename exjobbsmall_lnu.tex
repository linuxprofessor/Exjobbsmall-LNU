...
{\em Exempel 4:}\\
Enligt efternamn et al, [\#] mening mening mening mening.
...
{\em Exempel 6:}\\ 
Text text. ”Citat citat citat…”  ([\#], sidnummer). Text text text text text och så vidare. 

”Det finns många finfina blommor” (\cite{Creswell2014}, s 23). \\

{\em Exempel 7:}\\ 
Text text text text text och så vidare. 

Citat citat citat citat citat. Citat citat citat citat citat citat.\\
Citat citat citat citat citat citat. Citat citat citat citat citat citat.\\
([\#], sidnummer)
