...
\newcommand\BackgroundPic{
    \put(-2,-3){
    \includegraphics[keepaspectratio,scale=0.3]{lnu_etch.png} % Bakgrundsbild
    }
}
\newcommand\BackgroundPicLogo{
    \put(18,700){
    \includegraphics[keepaspectratio,scale=0.10]{logo.png} % Logga i övre vänstra hörnet
    }
}
...
\newpage
%------------------------------------------------
%	Bilagor, hanteras i separat fil
%------------------------------------------------
\appendix
\input{appendix}
\end{document}
